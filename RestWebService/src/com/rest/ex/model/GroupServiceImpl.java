...
public class GroupServiceImpl implements IGroupService {
	...
	/*
	 * @Override public void insertData() { //dos=new
	 * DataOperationsServiceImpl(); dos.insertData(); }
	 */
	@Override
	...
	private Group convertJsonToEntityObject(GroupJaxb grxb) {
		...
		for (BillAccountJaxb blla : grxb.getBillaccountList()) {
			...
			billAcc.setBpa_id(grxb.getBpa_id());
